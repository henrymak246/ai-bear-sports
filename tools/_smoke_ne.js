...
assert(bdHtml.includes('圣旺红星'), '最新期次(9-14)北单腿应在明细(只显示当日)');
assert(bdHtml.includes('北单380'), '明细编号应显示北单官方场次号(9-14=380圣旺红星)');
assert(!bdHtml.includes('皇家社会') && !bdHtml.includes('莱红牛'), '历史期次腿不应在明细(只显示当日, 2026-09-12起)');
