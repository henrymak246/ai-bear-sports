...
- `ahPick: '法兰克福-0.5' | '观望(原因)'` — 亚盘让球观点（2026-09-06 起；仅正式推荐的 asian7 腿写盘口，其余定位场写观望+原因，未定位场不写该字段）
- `ouPick: '大3.5(双证)' | '观望(原因)'` — 亚盘大小球观点（同上；仅大小盘方案腿写方向）。总览「预测」列自此分两行：🎫竞彩（方向｜总进球｜比分）/ 🌏亚盘（让球观点｜大小观点）
