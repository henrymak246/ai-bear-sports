...
- `ahPick: '法兰克福-0.5'` + `ahConf: 2` — 亚盘让球观点+信心指数（2026-09-06 起，V3.1 双体系独立：球探定位场每场必推，★1=低信心只展示、★2-3=可入 asian7 串关；未定位场不写该字段）
- `ouPick: '大3.5'` + `ouConf: 3` — 亚盘大小球观点+信心指数（同上；大小盘方案腿=ouConf top 腿）。总览「预测」列分两行：🎫竞彩（方向｜总进球｜比分）/ 🌏亚盘（让球观点★｜大小观点★）
